...
/***/ function(module, exports) {
	...
	View.prototype.exercise5 = function () {
	  ...
	  $squares.each(function(index) {
	    ...
	    $square.on("click", function() {
	      const data = $square.attr("data-pos");
	      console.log(data);
	      $square.html(data);
	    })
	  })
	...
	View.prototype.addRow = function() {
	  ...
	  //create a jQuery object (ul) called $row with two classes
	  ...
	  for(let colIdx = 0; colIdx < 20; colIdx++) {
	    ...
	    //append a jQuery object to the row
	    $row.append($square);
	  }
	  //append a jQuery row object to the easel
	  this.$el.append($row);
	};
